...
import { AvailNitroContracts2Point1Point0UpgradeAction, ProxyAdmin } from '../../../contracts/parent-chain/avail-nitro-contract-upgrades/AvailNitroContracts2Point1Point0UpgradeAction.sol';
...
/**
 * @title ExecuteAvailNitroContracts1Point2Point1UpgradeScript
 * @notice This script executes nitro contracts 2.1.0 upgrade through UpgradeExecutor
 */
contract ExecuteAvailNitroContracts2Point1Point0UpgradeScript is Script {
  function run() public {
    // used to check upgrade was successful
    bytes32 wasmModuleRoot = vm.envBytes32('WASM_MODULE_ROOT');

    AvailNitroContracts2Point1Point0UpgradeAction upgradeAction = AvailNitroContracts2Point1Point0UpgradeAction(
    ...
    bytes memory upgradeCalldata = abi.encodeCall(
      AvailNitroContracts2Point1Point0UpgradeAction.perform,
      (wasmModuleRoot, rollup, proxyAdmin)
    );
